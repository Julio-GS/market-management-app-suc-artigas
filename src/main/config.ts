...
import type { DesktopConfig, UpdateConfig } from "../shared/desktop-config";

export { decodeDesktopConfig, encodeDesktopConfig } from "../shared/desktop-config";
export type { DesktopConfig, OfflineConfig, UpdateConfig } from "../shared/desktop-config";
